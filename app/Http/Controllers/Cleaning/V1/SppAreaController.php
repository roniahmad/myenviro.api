...
use App\Models\Cleaning\V1\SppArea;

use App\Transformers\Cleaning\V1\SppAreaTransformer;
...
class SppAreaController extends BaseApiController
{
    ...
    public function getAreaBySppId(Request $request)
    {
        ...
        from cleaning.spp_area psa
        left join cleaning.spp ps on (ps.id=psa.spp_id)
        ...
        */
        ...
        $spp_id = $request->id;
        $resource = SppArea::leftJoin('cleaning.spp as ps', function($joinPSP){
