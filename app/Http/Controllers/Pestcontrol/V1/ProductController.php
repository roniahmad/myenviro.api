...
use App\Models\Pestcontrol\V1\ProdukLayanan;

use App\Transformers\Pestcontrol\V1\ProdukLayananTransformer;
    ...
    public function getProduct()
    {
        ...
        */
        $resource = ProdukLayanan::select(
                        'pestcontrol.produk_layanan.id','pestcontrol.produk_layanan.nama',
                        'pestcontrol.produk_layanan.deskripsi',
                        'pestcontrol.produk_layanan.gambar',
                        'pestcontrol.produk_layanan.narahubung', 'pestcontrol.produk_layanan.telp',
                        'pestcontrol.produk_layanan.email',
                        'll.nama as layanan'
                    )
                    ->leftJoin('layanan.layanan as ll', function($join){
                        $join->On('pestcontrol.produk_layanan.jenis_layanan','=','ll.id');
                    })
                    ->get();
